      ...
      */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <span className="font-geistmono text-[10px] text-green-500/80 tracking-[0.3em] uppercase animate-pulse">
            System Ready
          </span>
        </div>
        ...
        >
          ...
          <span className="font-geistmono text-xs text-green-400 tracking-widest font-bold uppercase">
            Unlock
          </span>
