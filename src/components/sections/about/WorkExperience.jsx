            ...
            >
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
                  <div>
                    <h3
                      className={`text-lg font-editorial font-bold transition-colors duration-300 ${
                    ...
                    <div className="text-sm text-gray-400 flex items-center gap-2 mt-1">
                      <span className="font-semibold font-geist text-gray-300">
                        {job.company}
                      </span>
                      {job.link !== "#" && (
                        <a
                  ...
                  <div className="flex items-center gap-2 text-xs font-geistmono text-gray-500 bg-white/5 px-2 py-1 rounded border border-white/5 w-fit">
                    <FiCalendar size={12} />
                    {job.period}
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {job.tags.map((tech, i) => (
                    <span
                      key={i}
                      className="px-2.5 py-1 text-[10px] font-geistmono text-green-400/80 bg-green-500/5 border border-green-500/10 rounded hover:bg-green-500/10 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
